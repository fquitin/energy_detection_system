...
int UHD_SAFE_MAIN(int argc, char *argv[]){
    ...
    if (vm.count("help")) {
        ...
        std::cout
            << std::endl
            << "This application streams data from a single channel of a USRP device changing the frequency and analysing the spectrum for N*rate selected. Each stream received are written in an appropriate file for each retune command .\n"
            << std::endl;
        return ~0;
    }
